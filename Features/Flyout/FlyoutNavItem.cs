...

{
	...
	[ObservableProperty] Color _titleColor = ThemeColors.OnSurface;

	[ObservableProperty] Color _rowBackground = Colors.Transparent;

	[ObservableProperty] bool _showActiveBar;
